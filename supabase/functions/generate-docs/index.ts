...
serve(async (req) => {
  ...
  try {
    ...
    const languages = options.languages || ['en', 'de', 'fr', 'ar'];
    ...
    const articles = [
      {
        ...
        title: {
          ...
          ar: 'البدء مع مساعد الامتثال والبيئة والمجتمع'
        },
        content: {
          en: `# Getting Started
...
1. **أكمل ملفك الشخصي**: انتقل إلى الإعدادات ← الملف الشخصي وأدخل تفاصيل مؤسستك
2. **ربط مصادر البيانات**: انتقل إلى الموصلات وربط أنظمة SAP أو Jira أو غيرها
3. **إجراء أول تقييم**: قم بزيارة مساعد قانون الذكاء الاصطناعي لتصنيف نظامك الأول

## الميزات الرئيسية

- **امتثال قانون الذكاء الاصطناعي**: تصنيف المخاطر الآلي وتوثيق المطابقة
- **ماسح خصوصية القانون العام لحماية البيانات**: اكتشاف البيانات الشخصية وإنشاء تقارير DSAR
- **تقارير الحوكمة البيئية والاجتماعية**: حساب وإبلاغ مقاييس الاستدامة
- **مسار التدقيق**: سجلات امتثال موثقة تشفيرياً

## هل تحتاج مساعدة؟

استخدم مساعد المساعدة بالذكاء الاصطناعي (أسفل اليمين) للحصول على إجابات فورية لأسئلتك.`
        },
      ...
      },
      {
        ...
        title: {
          ...
          ar: 'استخدام مساعد قانون الذكاء الاصطناعي'
        },
        content: {
...
6. Générez la documentation de l'Annexe IV si risque élevé`,
          ar: `# دليل مساعد قانون الذكاء الاصطناعي

يساعدك مساعد قانون الذكاء الاصطناعي في تصنيف أنظمة الذكاء الاصطناعي وفقاً لفئات المخاطر في قانون الذكاء الاصطناعي للاتحاد الأوروبي.

## كيفية الاستخدام

1. انتقل إلى **مساعد قانون الذكاء الاصطناعي** من الشريط الجانبي
2. انقر على **تقييم جديد**
3. املأ تفاصيل النظام:
   - اسم النظام
   - الغرض وحالة الاستخدام
   - المستخدمون المستهدفون
   - البيانات المعالجة
4. انقر على **تصنيف النظام**
5. راجع فئة المخاطر (الحد الأدنى، محدود، عالي، غير مقبول)
6. إنشاء وثائق الملحق الرابع إذا كان عالي المخاطر

## فئات المخاطر

- **الحد الأدنى من المخاطر**: لا توجد متطلبات خاصة
- **مخاطر محدودة**: التزامات الشفافية
- **مخاطر عالية**: تقييم المطابقة الكامل مطلوب
- **مخاطر غير مقبولة**: استخدامات محظورة

## التقارير المُنشأة

ينشئ المساعد:
- تقرير تصنيف المخاطر
- وثائق الملحق الرابع الفنية
- قائمة تقييم المطابقة
- ملخص الأدلة`
        },
        slug: 'ai-act-copilot'
      },
...
### SAP
الاتصال بـ SAP ERP للحصول على بيانات الموارد البشرية وسلسلة التوريد والسجلات المالية.

**خطوات الإعداد:**
1. انتقل إلى **الموصلات** ← **إضافة موصل**
2. حدد **SAP**
3. أدخل عنوان URL لمضيف SAP وبيانات الاعتماد
4. اختبر الاتصال
5. قم بتكوين جدول المزامنة

### Jira
مزامنة بيانات المشروع والمشكلات وسير العمل لتتبع نظام الذكاء الاصطناعي.

### SharePoint و OneDrive
اتصل بـ Microsoft 365 لمسح المستندات وتحليل القانون العام لحماية البيانات.

### Google Drive
استيراد المستندات لمسح الخصوصية.

## الأمان

تستخدم جميع الموصلات:
- بيانات اعتماد مشفرة (تخزين القبو)
- OAuth 2.0 حيثما كان متاحاً
- وصول للقراءة فقط بشكل افتراضي
- تسجيل التدقيق لجميع عمليات المزامنة`
        },
        slug: 'connectors'
      }
    ];
